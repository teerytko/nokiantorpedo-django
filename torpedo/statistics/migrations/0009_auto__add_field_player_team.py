...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'statistics_player', 'team',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['statistics.Team'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'statistics_player', 'team_id')
    ...
    models = {
        ...
        u'statistics.player': {
            ...
            'team': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['statistics.Team']", 'null': 'True', 'blank': 'True'})
        },
        u'statistics.team': {
